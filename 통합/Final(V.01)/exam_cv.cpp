...
/////////////////////////////////
  ...
  //     {
  //       if(binaryImg.at<uchar>(i, j) == 255 && a * j + b > (float)i) left_count++;
  //     }
  //   }
  //   // temp2[0] = a;
  //   // temp2[1] = b;
  ...
  //     for(int j = 0; j < binaryImg.cols ; j++)
  //     {
  //       if(binaryImg.at<uchar>(i, j) == 255 && a * j + b > (float)i) right_count++;
  //     }
  //   }
  //   // temp2[0] = a;
  //   // temp2[1] = b;
  ...
  // else if(!left_error)
  // {
  //   if(left_count < 50) return 3; // GO left
  //   else return 2; // GO right
  // }
  // if(!right_error)
  // {
  //   if(right_count > 1000) return 3; // GO right
  //   else return 2; // GO left
  // }
  // else return 2;
