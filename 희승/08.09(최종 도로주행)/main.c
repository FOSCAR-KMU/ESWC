...
volatile float check_slope = 0.0f;
...
static void drive(struct display *disp, struct buffer *cambuf)
{
    ...
    if(get_framebuf(cambuf, cam_pbuf) == 0) {
        ...
        gettimeofday(&st, NULL);
          ...
          // check_slope = get_slope_curve(srcbuf, VPE_OUTPUT_W, VPE_OUTPUT_H, cam_pbuf[0], VPE_OUTPUT_W, VPE_OUTPUT_H);
        ...
        //
        //
        //   if(outbreak_flag == 1 && stop_line_flag == 0 && stop_line_detector(srcbuf, VPE_OUTPUT_W, VPE_OUTPUT_H, cam_pbuf[0], VPE_OUTPUT_W, VPE_OUTPUT_H)){
        //     stop_line_flag = 1;
        //   }
        //
...
int main(int argc, char **argv)
{
  ...
  const int max_outbreak_thrshold = 10000;
  const int min_outbreak_thrshold = 2000;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    // else if(outbreak_flag == 1 && rotary_flag == 0){
    //
    //   int flag = 0;
