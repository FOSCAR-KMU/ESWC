...
static void drive(struct display *disp, struct buffer *cambuf)
{
    ...
    if(get_framebuf(cambuf, cam_pbuf) == 0) {
        ...
        if(mode == 3){
          ...
          //   temp_angle = 1225;
          // }
          // else if(temp_angle > 1775){
          //   temp_angle = 1775;
          // }
          if(temp_angle < 1250){
            temp_angle = 1250;
          }
          else if(temp_angle > 1750){
            temp_angle = 1750;
          }
        }
...
void left_rotate(){
  ...
  if(check_yellow_line){
    ...
    temp = data_transformF(ab[0], -0.11, 0.11,  1500000.0, 200000.0);
    usleep((int) temp);
    DesireSpeed_Write(50);

    steer = data_transformF(ab[0], -0.11, 0.11, 500.0, 425.0);
...
void right_rotate(){
  ...
  if(check_yellow_line){
    ...
    temp = data_transformF(ab[0], -0.11, 0.11,  200000.0, 1500000.0);

    usleep((int) temp);
    DesireSpeed_Write(50);

    steer = data_transformF(ab[0], -0.11, 0.11, 425.0, 500.0);
