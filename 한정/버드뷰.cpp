...
pair<bool, vector<Point> > find_point_4_top_view(Mat srcImg){
  ...
  threshold(leftROI,  binaryImg1, 230, 255, CV_THRESH_BINARY);
  threshold(rightROI, binaryImg2, 230, 255, CV_THRESH_BINARY);


  Canny(binaryImg1, cannyImg1, 200, 250);
  Canny(binaryImg2, cannyImg2, 200, 250);
...
int main(){
    ...
    vector<Point> v = find_point_4_top_view(src).second;
